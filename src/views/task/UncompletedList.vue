<script setup>
import { getUncompletedListService, completeTaskService, moveToTrashService } from '@/api/task.js'
...
const fetchUncompletedList = async () => {
    try {
        const res = await getUncompletedListService()
        if (res.data) {
            uncompletedTaskList.value = res.data
        }
    } catch (error) {
...
<template>
    <el-card class="page-container">
        ...
        <el-table :data="uncompletedTaskList" style="width: 100%">
